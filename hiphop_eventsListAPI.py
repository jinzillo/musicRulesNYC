...
while loop_counter < 4:  
    ...
    events = api.call('/events/search', q='tag: hiphop', date='2017110100-2017113000', category='concerts', location='New York City', within=10, page_count=20, page_number=loop_counter)
